...
namespace WorldOfZuul
{
    public sealed class GlacialBiome : Biome
    {
        ...
        public GlacialBiome()
        {
            Room? glacialRoom1 = new("Snow Village", "You’re in a small Snow Village. There’s not many people. Everyone is wearing warm clothes. There’s a lot of snow everywhere. It’s hard to walk. It’s very cold. On the west you can see ice/snow desert. It’s not a good idea to go there, you might get lost. You can see some buildings on the south.", new List<Item> { new Item("x", "...") });
            Room? glacialRoom2 = new("Room 2", "On the east you can see the Ice Island. But there’s no bridge that you could use to get there.", new List<Item> { new Item("x", "...") });
            Room? glacialRoom3 = new("Room 3", "On the west there is the Ice Lake. You can’t go there. On the south you can see a huge ice mountain. It’s dangerous to go there without proper equipment.", new List<Item> { new Item("x", "...") });
            ...
            Room? glacialRoom6 = new("Snowy Hillside", "The top of the ice mountain is on the south. It looks very slippery though.", new List<Item> { new Item("x", "...") });
            Room? glacialRoom7 = new("The bottom of the Ice Mountain", "You’re at the bottom of the Ice Mountain", new List<Item> { new Item("x", "...") });
            ...
            Room? glacialRoom9 = new("Ice Cave", "You've entered an Ice Cave. It's dark here, you can't really see anything.", new List<Item> { });
            Room? glacialRoom10 = new("Ice Island", "You're on the Ice Island, surrounded by water.", new List<Item> { });
