...
namespace WorldOfZuul
{
    public class GrasslandsBiome : Biome
    {
        ...
        public GrasslandsBiome()
        {
            ...
            Room? GrasslandsRoom3 = new("Animal Aid", "You fnd yourself in an huge place and somone is here to help you.", new List<Item> { new Item("TrackingDevice", "Helpful to make your way back") }, new List<NPC> { });
            ...
            Room? GrasslandsRoom5 = new(/* animal room 1 */ "Open Field", "You see some animals walking around peacefully. Take a closer look.", new List<Item> { }, new List<NPC> { });
            Room? GrasslandsRoom6 = new(/* animal room 2 */ "Migration Camp", "You can notice some trees missing their leaves and a small pond. Some animals are happily drinking some water.", new List<Item> { }, new List<NPC> { });
            Room? GrasslandsRoom7 = new(/*animal room 3 */ "Smalle ", "message", new List<Item> { }, new List<NPC> { });
